...
const KNOWN_RUNNERS = new Set(['merge', 'split', 'compress', 'jpg2pdf', 'pdf2jpg', 'pdf2word', 'pdf2excel', 'pdf2ppt', 'pdf2md', 'unlock', 'worker', 'organize', 'resize', 'fillOrder', 'cleanScan', 'mangaSplit']);
