...
//
// One more file than packages/pdf2md-core's own copy-core.mjs:
// pdf2wordBorders.js (border-grid/gridSpan table detection) — pdf2md never
// uses it, Read PDF's reflow does.
