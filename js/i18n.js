...
const EN = {
  ...
  err_encrypted_pdf:    'This PDF is password-protected or has editing restrictions. Remove the password first (use Acrobat or a trusted tool with the owner password), then try again.',
