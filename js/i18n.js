...
export const EN = {
  ...
  prog_glossary_load:   'Loading PDF...',
  prog_glossary_search: 'Searching for terms...',
  prog_glossary_write:  'Adding definitions...',
  prog_clean_scan_load: 'Loading PDF...',
  prog_clean_scan_page: 'Cleaning page {n} of {total}...',
  prog_ereader_load:    'Loading PDF...',
  prog_ereader_analyze: 'Detecting margins...',
  prog_ereader_page:    'Optimizing page {n} of {total}...',
  prog_redact:       'Covering areas...',
  prog_flatten:      'Flattening form fields...',
  prog_manga_split:  'Splitting pages...',
  ...
  desc_batch_compress_done:    'Compressed {n} files · processed locally · no upload',
  desc_batch_compress_partial: '{ok} of {total} files compressed · processed locally · no upload',
  ...
  desc_glossary:            '{count} definitions added',
  desc_resize:              'Resized · {pages} pages · {size}',
  desc_clean_scan:          'Cleaned · {pages} pages · {size}',
  ...
  warn_glossary_truncated: '⚠️ Too many matches — only the first {n} were annotated. Try narrowing your term list.',
  ...
  // ── organizeUI.js ──────────────────────────────────────────────
  org_loading:           'Loading PDF…',
  org_err_load:          'Could not read PDF: {msg}',
  org_toolbar_aria:      'Rotation',
  org_ccw_title:         'Rotate 90° counter-clockwise',
  org_180_title:         'Rotate 180°',
  org_cw_title:          'Rotate 90° clockwise',
  org_quick_aria:        'Quick select',
  org_select_label:      'Select:',
  org_delete_selected:   '✕ Delete selected',
  ...
  org_deleted_suffix:    ' (deleted)',
  org_hint_click:        'Drag to reorder, click to select, or delete pages',
  org_banner:            '🔒 Processed entirely in your browser · No upload',
  org_btn_no_pages:      'Delete fewer pages to continue',
  org_btn_one:           '🗂️ Save {n} page',
  org_btn_many:          '🗂️ Save {n} pages',
  val_organize_no_pages: 'Delete fewer pages — at least one must remain.',
  val_glossary_no_dictionary: 'Add a PDF and at least one term to continue.',
  val_glossary_no_matches:    'None of your dictionary terms were found in this PDF.',
  val_glossary_no_text_layer: 'This PDF has no selectable text — Glossary needs a text-based PDF. If it’s a scanned document, try PDFree’s OCR tool first.',
  gls_intro:                  'This tool creates clickable highlights over matching terms — it does not change or rewrite your PDF’s original text.',
  gls_file_label:              'File',
  gls_dictionary_label:        'Term dictionary',
  gls_dictionary_hint:         'One entry per line: term - definition',
  gls_dictionary_placeholder:  'dharma - cosmic law and duty\nkarma - the principle of cause and effect',
  gls_parsed_count:            '{n} term(s) parsed',
  ...
  rsz_err_load:          'Could not read PDF: {msg}',
  rsz_preview_alt:       'Page 1 preview',
  rsz_paper_size:        'Paper size',
  rsz_size_custom: "Custom",
  rsz_custom_width: "Width (mm)",
  rsz_custom_height: "Height (mm)",
  rsz_mode:              'Fit mode',
  rsz_margin:            'Margin',
  rsz_orientation:       'Orientation',
  rsz_mode_fit:          'Fit',
  rsz_mode_fill:         'Fill',
  rsz_mode_actual:       'Actual size',
  rsz_margin_none:       'None',
  rsz_margin_small:      'Small',
  rsz_margin_normal:     'Normal',
  rsz_margin_large:      'Large',
  rsz_orient_auto:       'Auto — match source orientation',
  rsz_orient_portrait:   'Portrait',
  rsz_orient_landscape:  'Landscape',
  rsz_summary:           '{from} → {to} · Scale {pct}%',
  rsz_summary_no_shrink: '{from} → {to} · No shrinking needed',
  rsz_clip_warning:      '⚠️ Content is larger than the page — edges will be clipped',
  rsz_banner:            '🔒 Processed entirely in your browser · No upload',

  // ── mangaSplitUI.js ────────────────────────────────────────────
  ms_loading:            'Loading PDF…',
  ms_err_load:           'Could not read PDF: {msg}',
  ms_rtl_title:          'Manga reading order',
  ms_rtl_subtitle:       'Right page comes first in the output',
  ms_grid_aria:          'PDF pages — click a page to keep it uncut',
  ms_page_aria:          'Page {n}',
  ms_page_alt:           'Page {n}',
  ...
  ms_survey_why_print:   'To print',
  ms_survey_why_device:  'To read on a device',
  ms_survey_why_other:   'Other',
  ms_survey_annoying:    'What was the most annoying part?',
  ms_survey_before:      'What did you use before this tool?',
  ms_survey_pay_q:       'Would you pay for an advanced version (text, booklet layout)?',
  ms_survey_pay_yes:     'Yes',
  ms_survey_pay_no:      'No',
  ms_survey_pay_maybe:   'Maybe',
  ms_survey_submit:      'Send',
  ms_survey_skip:        'Skip',
  ms_survey_thanks:      'Thanks for the feedback!',

  // ── cleanScanUI.js ───────────────────────────────────────────
  cs_loading:            'Analyzing scan…',
  cs_err_load:           'Could not read PDF: {msg}',
  cs_mode:               'Mode',
  cs_mode_clean:         'Clean',
  cs_mode_enhance:       'Enhance',
  cs_strength:           'Strength',
  cs_quality:            'Quality',
  cs_quality_standard:   'Standard',
  cs_quality_high:       'High quality',
  cs_preview_page:       'Preview page',
  cs_before:             'Before',
  cs_after:              'After',
  cs_color_warning:      'This page contains color — Clean mode may remove it.',
  cs_switch_enhance:     'Switch to Enhance',
  cs_digital_warning:    "This doesn't look like a scan — cleaning may turn text into an image.",
  cs_banner:             '🔒 Processed entirely in your browser · No upload',

  // ── ereaderUI.js ───────────────────────────────────────────────
  er_loading:            'Analyzing pages…',
  er_err_load:           'Could not read PDF: {msg}',
  er_device:             'Device',
  er_device_kindle:      'Kindle',
  er_device_remarkable:  'reMarkable / Boox',
  er_device_kobo:        'Kobo / Nook',
  er_grayscale:          'Grayscale',
  er_contrast:           'Contrast',
  er_preview_page:       'Preview page',
  er_before:             'Before',
  er_after:              'After',
  ...
  rdct_pii_iban:           '🏦 IBAN',
  rdct_pii_url:            '🌐 URL',
  rdct_pii_ai_name:        '🤖 AI Names (Beta)',
  rdct_ai_name_disclosure: 'AI-detected names & places. Works best with English text — always review before applying.',
  rdct_ai_name_loading:    'Loading AI model…',
  rdct_ai_name_error:      "Couldn't load the AI model. Check your connection and try again.",
  ...
  wm_pagerange_label:    'Apply to pages',
  wm_from_page:          'From page',
  wm_to_page:            'To page',
  wm_to_page_all:        '(∞ = all)',
  wm_aria_dec_from:      'Decrease from page',
  wm_aria_inc_from:      'Increase from page',
  wm_aria_dec_to:        'Decrease to page',
  wm_aria_inc_to:        'Increase to page',
  wm_layer_label:        'Layer',
  wm_layer_front:        'In front',
  wm_layer_behind:       'Behind content',
  wm_layer_behind_hint:  'Preview always shows the watermark on top — in the downloaded PDF it renders behind your page content.',
  ...
  val_formfields_dropdown_empty: 'Add at least one choice to every dropdown field',
  ...
  j2p_scan_brightness:       'Brightness',
  j2p_scan_contrast:         'Contrast',
  j2p_scan_reset:            'Reset',
  ...
  scan_cam_rotate_left:      'Rotate left',
  scan_cam_rotate_right:     'Rotate right',
  scan_cam_reset_crop:       'Reset crop',
  scan_cam_erase:            'Erase',
  scan_cam_erase_brush:      'Brush',
  scan_cam_erase_done:       'Done',
  scan_cam_brush_small:      'Small brush',
  scan_cam_brush_medium:     'Medium brush',
  scan_cam_brush_large:      'Large brush',
  ...
  sd_batch_title:          'Batch processing',
  sd_batch_prompt:         'You selected {n} photos. Review each one, or auto-crop and filter all of them the same way?',
  sd_batch_review_each:    'Review each',
  sd_batch_auto_all:       'Apply to all automatically',
  ...
  p2j_dpi_300_lbl:        'Print quality',
  p2j_dpi_300_sub:        'Larger file size',
  ...
  p2w_strip_meta_title: "Delete original file info",
  p2w_strip_meta_subtitle: "Removes the PDF's author, title, and other identifying details from the result",
  p2w_keep_meta_hint: "🔓 Your PDF's original author and title will be kept in the result, instead of generic PDFree file info.",
  ...
  fill_progress_suffix:      '/ {total} filled',
  ...
  fill_sign_here:            'Sign here',
  fill_type_placeholder:     'Type your name',
  fill_upload_tap:           'Tap to choose a signature image',
  fill_upload_formats:       'PNG, JPG, SVG',
  fill_hint_draw_portrait:   'Sign along the dashed line — draw left to right',
  fill_hint_draw:            'Sign along the dashed line',
  fill_hint_type:            'Type your name — preview updates live',
  fill_hint_upload:          'Upload a PNG, JPG, or SVG image of your signature',
  fill_done_btn:             'Done ✓',
  fill_sig_disclaimer_footer: 'Visual signature only — not a PKI digital signature.',
  fill_re_sign:              'Re-sign',
  ...
  formfields_type_radio:         'Radio',
  formfields_type_dropdown:      'Dropdown',
  formfields_group_label:        'Radio group name',
  formfields_group_placeholder:  'Group name',
  formfields_new_group:          'New group',
  formfields_group_hint:         'Radio buttons placed while this name is set form one group — only one of them can be selected. Editing the name renames the whole group; use New group to start another.',
  formfields_options_label:      'Dropdown choices (separated by commas)',
  formfields_options_placeholder: 'Small, Medium, Large',
  formfields_options_hint:       'Type each choice separated by a comma. Click a placed dropdown to edit its choices.',
  formfields_radio_box_title:    'Group: {group} · Option: {value}',
  ...
  formfields_default_group_name:    'Group {n}',
