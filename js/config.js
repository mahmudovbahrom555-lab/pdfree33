...
export const TOOLS = {
  ...
  pagenum: {
    ...
    btn:    '🔢 Add Numbers',
    titles: { en: 'Page Numbers',  es: 'Números de página',  pt: 'Números de página',  de: 'Seitenzahlen',           fr: 'Numérotation PDF', id: 'Nomor Halaman', vi: 'Số Trang PDF', tr: 'Sayfa Numarası Ekle' },
    descs:  { en: 'Add numbered footers — Arabic, Roman or ABC', es: 'Añade números de página en el pie — Arábigos, Romanos o ABC', pt: 'Adicione números de página no rodapé — Arábicos, Romanos ou ABC', de: 'Nummerierte Fußzeilen hinzufügen — Arabisch, Römisch oder ABC', fr: 'Ajouter des pieds de page numérotés — arabe, romain ou alphabétique', id: 'Tambah footer bernomor — Arab, Romawi atau ABC', vi: 'Thêm chân trang có số — Ả Rập, La Mã hoặc ABC', tr: "PDF'ye özelleştirilebilir sayfa numaraları ekleyin" },
    btns:   { en: '🔢 Add Numbers', es: '🔢 Añadir números', pt: '🔢 Adicionar números', de: '🔢 Nummern hinzufügen', fr: '🔢 Ajouter la numérotation', id: '🔢 Tambah Nomor Halaman', vi: '🔢 Thêm Số Trang', tr: '🔢 Sayfa Numarası Ekle' },
    multi:       false,
    accept:      '.pdf,application/pdf',
    implemented: true,
  },
  ...
  'pdf2word': {
    ...
    titles: { en: 'PDF to Word', es: 'PDF a Word', pt: 'PDF para Word', de: 'PDF zu Word', fr: 'PDF en Word' },
  ...
  'pdf2ppt': {
    ...
    titles: { en: 'PDF to PowerPoint' },
    descs:  { en: 'Convert PDF pages into slides — runs in your browser, no upload' },
  ...
  'pdf2md': {
    ...
    titles: { en: 'PDF to Markdown' },
    descs:  { en: 'Convert PDF text, headings and lists into Markdown — runs in your browser, no upload' },
  ...
  unlock: {
    ...
    titles: { en: 'Unlock PDF' },
    descs:  { en: 'Remove PDF password protection — runs in your browser, no upload' },
  ...
  flatten: {
    ...
    titles: { en: 'Flatten PDF', es: 'Aplanar PDF', pt: 'Nivelar PDF', de: 'PDF glätten', fr: 'Aplatir PDF' },
    descs:  { en: 'Bake form fields into the page — make PDF non-editable', es: 'Incrusta campos de formulario — hace el PDF no editable', pt: 'Incorpora campos de formulário — torna o PDF não editável', de: 'Formularfelder einbetten — PDF nicht bearbeitbar machen', fr: 'Intégrer les champs de formulaire — rendre le PDF non modifiable' },
