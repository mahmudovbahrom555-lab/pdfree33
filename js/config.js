...
export const TOOLS = {
  ...
  rotate: {
    ...
    btn:    '🔄 Rotate PDF',
    titles: { en: 'Rotate PDF', es: 'Rotar PDF', pt: 'Girar PDF', de: 'PDF Drehen', fr: 'Rotation PDF', id: 'Putar PDF', vi: 'Xoay PDF', ru: 'Повернуть PDF', ja: 'PDFを回転', tr: 'PDF Döndür' },
    descs:  { en: 'Fix page orientation in any PDF', es: 'Arregla la orientación de páginas en cualquier PDF', pt: 'Corrija a orientação das páginas em qualquer PDF', de: 'Seitenausrichtung in beliebigen PDFs korrigieren', fr: "Corriger l'orientation des pages dans n'importe quel PDF", id: 'Perbaiki orientasi halaman di PDF mana pun', vi: 'Sửa hướng trang trong bất kỳ PDF nào', ru: 'Исправляйте ориентацию страниц в любом PDF', ja: 'どのPDFでもページの向きを修正する', tr: 'PDF sayfalarının yönünü düzeltin' },
    btns:   { en: '🔄 Rotate PDF', es: '🔄 Rotar PDF', pt: '🔄 Girar PDF', de: '🔄 PDF drehen', fr: '🔄 Faire pivoter', id: '🔄 Putar PDF', vi: '🔄 Xoay PDF', ru: '🔄 Повернуть PDF', ja: '🔄 PDFを回転', tr: '🔄 PDF Döndür' },
    multi:       false,
    accept:      '.pdf,application/pdf',
    implemented: true,
  },
  extract: {
    ...
    btn:    '📑 Extract Pages',
    titles: { en: 'Extract Pages', es: 'Extraer Páginas', pt: 'Extrair Páginas', de: 'Seiten Extrahieren', fr: 'Extraire Pages', id: 'Ekstrak Halaman', vi: 'Trích Xuất Trang', ru: 'Извлечь страницы', ja: 'ページを抽出', tr: 'Sayfa Çıkar' },
    descs:  { en: 'Pull selected pages into a new PDF', es: 'Extrae páginas seleccionadas a un nuevo PDF', pt: 'Extraia páginas selecionadas para um novo PDF', de: 'Ausgewählte Seiten in ein neues PDF extrahieren', fr: 'Extraire des pages sélectionnées dans un nouveau PDF', id: 'Ambil halaman terpilih ke PDF baru', vi: 'Lấy các trang được chọn vào PDF mới', ru: 'Извлекайте выбранные страницы в новый PDF', ja: '選択したページを新しいPDFにまとめる', tr: "PDF'den belirli sayfaları çıkarın" },
    btns:   { en: '📑 Extract Pages', es: '📑 Extraer páginas', pt: '📑 Extrair páginas', de: '📑 Seiten extrahieren', fr: '📑 Extraire les pages', id: '📑 Ekstrak Halaman', vi: '📑 Trích Xuất Trang', ru: '📑 Извлечь страницы', ja: '📑 ページを抽出', tr: '📑 Sayfa Çıkar' },
    multi:       false,
    accept:      '.pdf,application/pdf',
    implemented: true,
  },
  ...
  meta: {
    ...
    btn:    '🏷️ Save Metadata',
    titles: { en: 'Edit Metadata', es: 'Editar Metadatos', pt: 'Editar Metadados', de: 'Metadaten Bearbeiten', fr: 'Métadonnées PDF', id: 'Edit Metadata', vi: 'Chỉnh Sửa Metadata', tr: 'PDF Meta Verisi' },
    descs:  { en: 'View and edit title, author, keywords', es: 'Ver y editar título, autor, palabras clave', pt: 'Ver e editar título, autor, palavras-chave', de: 'Titel, Autor, Schlüsselwörter anzeigen und bearbeiten', fr: 'Afficher et modifier titre, auteur, mots-clés', id: 'Lihat dan edit judul, penulis, kata kunci', vi: 'Xem và chỉnh sửa tiêu đề, tác giả, từ khóa', tr: "PDF'nin Yazar, Başlık ve anahtar kelimelerini düzenleyin" },
    btns:   { en: '🏷️ Save Metadata', es: '🏷️ Guardar metadatos', pt: '🏷️ Salvar metadados', de: '🏷️ Metadaten speichern', fr: '🏷️ Enregistrer les métadonnées', id: '🏷️ Edit Metadata', vi: '🏷️ Chỉnh Sửa Metadata', tr: '🏷️ PDF Meta Verisi' },
    multi:       false,
    accept:      '.pdf,application/pdf',
    implemented: true,
  },
  protect: {
    ...
    descs:  { en: 'AES-256 password & permissions — 100% private', es: 'Contraseña AES-256 y permisos — 100% privado', pt: 'Senha AES-256 e permissões — 100% privado', de: 'AES-256-Passwort und Berechtigungen — 100 % privat', fr: 'Mot de passe AES-256 et permissions — 100 % privé', id: 'Kata sandi AES-256 & izin — 100% pribadi', vi: 'Mật khẩu AES-256 & quyền — 100% riêng tư', ru: 'Пароль AES-256 и права — 100% конфиденциально', ja: 'AES-256パスワード & アクセス権 — 100%プライベート', it: 'Proteggi PDF con password AES-256 — nessun upload', ko: 'AES-256로 PDF에 비밀번호 설정 — 업로드 없음', nl: 'PDF beveiligen met AES-256-wachtwoord — geen upload', pl: 'Zabezpiecz PDF hasłem AES-256 — bez przesyłania', tr: "PDF'i AES-256 parolayla koru — yükleme yok" },
  ...
  'draw-pdf': {
    ...
    titles: { en: 'Draw on PDF', es: 'Dibujar en PDF', pt: 'Desenhar no PDF', de: 'Auf PDF zeichnen', fr: 'Dessiner sur PDF' },
  ...
  ocr: {
    ...
    titles: { en: 'OCR PDF', es: 'OCR PDF', pt: 'OCR PDF', de: 'PDF-Texterkennung', fr: 'PDF OCR' },
  ...
  'pdf2word': {
    ...
    titles: { en: 'PDF to Word', es: 'PDF a Word', pt: 'PDF para Word', de: 'PDF zu Word', fr: 'PDF en Word', id: 'PDF ke Word', vi: 'PDF sang Word', ru: 'PDF в Word', ja: 'PDFをWordに', tr: "PDF'den Word'e", it: 'PDF in Word', ko: 'PDF to Word', nl: 'PDF naar Word', pl: 'PDF do Word' },
    ...
    btns:   { en: '📝 Convert to Word', es: '📝 Convertir a Word', pt: '📝 Converter para Word', de: '📝 In Word konvertieren', fr: '📝 Convertir en Word', id: '📝 PDF ke Word', vi: '📝 PDF sang Word', ru: '📝 PDF в Word', ja: '📝 PDFをWordに', tr: "📝 PDF'den Word'e", it: '📝 PDF in Word', ko: '📝 PDF to Word', nl: '📝 PDF naar Word', pl: '📝 PDF do Word' },
    btn:         '📝 Convert to Word',
    multi:       false,
    accept:      '.pdf,application/pdf',
    implemented: true,
  ...
  'pdf2excel': {
    ...
    titles: { en: 'PDF to Excel', es: 'PDF a Excel', pt: 'PDF para Excel', de: 'PDF zu Excel', fr: 'PDF en Excel', id: 'PDF ke Excel', vi: 'PDF sang Excel', ru: 'PDF в Excel', ja: 'PDFからExcel', it: 'PDF in Excel', ko: 'PDF to Excel', nl: 'PDF naar Excel', pl: 'PDF do Excel', tr: "PDF'den Excel'e" },
    ...
    btns:   { en: '📊 Convert to Excel', es: '📊 Convertir a Excel', pt: '📊 Converter para Excel', de: '📊 In Excel konvertieren', fr: '📊 Convertir en Excel', id: '📊 PDF ke Excel', vi: '📊 PDF sang Excel', ru: '📊 PDF в Excel', ja: '📊 PDFからExcel', it: '📊 PDF in Excel', ko: '📊 PDF to Excel', nl: '📊 PDF naar Excel', pl: '📊 PDF do Excel', tr: "📊 PDF'den Excel'e" },
  ...
  'pdf2md': {
    ...
    titles: { en: 'PDF to Markdown', es: 'PDF a Markdown', pt: 'PDF para Markdown', de: 'PDF zu Markdown', fr: 'PDF en Markdown', tr: "PDF'den Markdown'a", id: 'PDF ke Markdown', vi: 'PDF sang Markdown', ru: 'PDF в Markdown', ja: 'PDFからMarkdown', it: 'PDF in Markdown', ko: 'PDF to Markdown', nl: 'PDF naar Markdown', pl: 'PDF do Markdown' },
    ...
    btns:   { en: '📝 Convert to Markdown', es: '📝 PDF a Markdown', pt: '📝 PDF para Markdown', de: '📝 PDF zu Markdown', fr: '📝 PDF en Markdown', tr: "📝 PDF'den Markdown'a", id: '📝 PDF ke Markdown', vi: '📝 PDF sang Markdown', ru: '📝 PDF в Markdown', ja: '📝 PDFからMarkdown', it: '📝 PDF in Markdown', ko: '📝 PDF to Markdown', nl: '📝 PDF naar Markdown', pl: '📝 PDF do Markdown' },
  ...
  unlock: {
    ...
    titles: { en: 'Unlock PDF', es: 'Desbloquear PDF', pt: 'Desbloquear PDF', de: 'PDF entsperren', fr: 'Déverrouiller PDF', tr: 'PDF Kilidi Aç' },
    descs:  { en: 'Remove PDF password protection — runs in your browser, no upload', es: 'Elimina la protección por contraseña localmente', pt: 'Remova a proteção por senha localmente', de: 'Passwortschutz lokal entfernen', fr: 'Supprimer la protection par mot de passe localement', tr: "PDF'den parola ve kısıtlamaları kaldırın" },
    btns:   { en: '🔓 Remove Password Protection', es: '🔓 Desbloquear PDF', pt: '🔓 Desbloquear PDF', de: '🔓 PDF entsperren', fr: '🔓 Déverrouiller PDF', tr: '🔓 PDF Kilidi Aç' },
  ...
  flatten: {
    ...
    titles: { en: 'Flatten PDF', es: 'Aplanar PDF', pt: 'Nivelar PDF', de: 'PDF glätten', fr: 'Aplatir PDF', id: 'Ratakan PDF', vi: 'Làm Phẳng PDF', tr: 'PDF Düzleştir' },
    descs:  { en: 'Bake form fields into the page — make PDF non-editable', es: 'Incrusta campos de formulario — hace el PDF no editable', pt: 'Incorpora campos de formulário — torna o PDF não editável', de: 'Formularfelder einbetten — PDF nicht bearbeitbar machen', fr: 'Intégrer les champs de formulaire — rendre le PDF non modifiable', id: 'Tanam kolom formulir ke halaman — cegah pengeditan', vi: 'Nhúng trường biểu mẫu vào trang — ngăn chỉnh sửa', tr: 'PDF form alanlarını kalıcı olarak kilitleyin' },
    btns:   { en: '🔒 Lock PDF Form', es: '🔒 Bloquear formulario', pt: '🔒 Bloquear formulário', de: '🔒 Formular sperren', fr: '🔒 Verrouiller le formulaire', id: '🔒 Ratakan PDF', vi: '🔒 Làm Phẳng PDF', tr: '🔒 PDF Düzleştir' },
    btn:         '🔒 Lock PDF Form',
    multi:       false,
    accept:      '.pdf,application/pdf',
    implemented: true,
