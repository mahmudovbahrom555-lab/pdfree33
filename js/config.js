...
export const TOOLS = {
  ...
  flatten: {
    ...
    titles: { en: 'Flatten PDF', es: 'Aplanar PDF', pt: 'Achatar PDF', de: 'PDF glätten', fr: 'Aplatir PDF', id: 'Ratakan PDF', vi: 'Làm Phẳng PDF', ru: 'Зафиксировать PDF', ja: 'PDFをフラット化', it: 'Appiattisci PDF', ko: 'PDF 평면화', nl: 'PDF Afvlakken', pl: 'Spłaszcz PDF', tr: 'PDF Düzleştir' },
