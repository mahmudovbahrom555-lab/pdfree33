...
export const TOOLS = {
  ...
  redact: {
    ...
    btn:    '🖌️ Redact PDF',
    titles: { en: 'Redact PDF', es: 'Censurar PDF', pt: 'Censurar PDF', de: 'PDF Schwärzen', fr: 'Caviarder PDF', id: 'Hapus Teks PDF', vi: 'Xóa Văn Bản PDF', ru: 'Скрыть текст', ja: 'PDFを黒塗り', it: 'Oscura PDF', ko: 'PDF 가리기', nl: 'PDF Zwartmaken', pl: 'Zaczernij PDF', tr: 'PDF Gizle' },
    ...
    btns:   { en: '🖌️ Redact PDF', es: '🖌️ Censurar PDF', pt: '🖌️ Censurar PDF', de: '🖌️ PDF schwärzen', fr: '🖌️ Caviarder PDF', id: '🖌️ Hapus Teks PDF', vi: '🖌️ Xóa Văn Bản PDF', ru: '🖌️ Скрыть текст', ja: '🖌️ PDFを黒塗り', it: '🖌️ Oscura PDF', ko: '🖌️ PDF 가리기', nl: '🖌️ PDF Zwartmaken', pl: '🖌️ Zaczernij PDF', tr: '🖌️ PDF Gizle' },
    multi:       false,
    accept:      '.pdf,application/pdf',
    implemented: true,
  },
