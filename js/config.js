...
export const TOOLS = {
  ...
  meta: {
    ...
    btn:    '🏷️ Save Metadata',
    titles: { en: 'Edit Metadata', es: 'Editar Metadatos', pt: 'Editar Metadados', de: 'Metadaten Bearbeiten', fr: 'Métadonnées PDF', id: 'Edit Metadata', vi: 'Chỉnh Sửa Metadata', ru: 'Редактировать метаданные', ja: 'メタデータを編集', it: 'Modifica Metadati', ko: '메타데이터 편집', nl: 'Metadata Bewerken', pl: 'Edytuj Metadane', tr: 'PDF Meta Verisini Düzenle' },
