...
window.PDFREE_LOCALE = {
  ...
  rdct_banner_cover:       '🛡️ <strong>Cubrir área</strong> — dibuja un rectángulo opaco sobre la región seleccionada. El contenido debajo está oculto visualmente pero <em>no borrado criptográficamente</em>. Para redacción legal use la herramienta <a href="/redact-pdf/" style="color:var(--green)">Redactar PDF</a>.',
