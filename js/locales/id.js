...
window.PDFREE_LOCALE = {
  ...
  pdfa_convert_btn:            '📐 Konversi ke PDF/A-2b',
  pdfa_converting:             'Mengonversi…',
  pdfa_convert_failed:         'Konversi gagal',
  pdfa_convert_failed_detail:  'Konversi gagal: {message}',
  pdfa_convert_success:        '✓ Dikonversi — pemeriksaan mandiri mengonfirmasi penanda OutputIntent dan XMP di file yang diunduh.',
