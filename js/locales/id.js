...
window.PDFREE_LOCALE = {
  ...
  prog_glossary_load:   'Memuat PDF...',
  prog_glossary_search: 'Mencari istilah...',
  prog_glossary_write:  'Menambahkan definisi...',
  ...
  desc_glossary:            '{count} definisi ditambahkan',
  ...
  warn_glossary_truncated: '⚠️ Terlalu banyak kecocokan — hanya {n} pertama yang diberi anotasi. Coba persempit daftar istilah Anda.',
  ...
  val_glossary_no_dictionary: 'Tambahkan PDF dan minimal satu istilah untuk melanjutkan.',
  val_glossary_no_matches:    'Tidak ada istilah dari kamus Anda yang ditemukan di PDF ini.',
  val_glossary_no_text_layer: 'PDF ini tidak memiliki teks yang bisa dipilih — Glosarium memerlukan PDF berbasis teks. Jika ini dokumen hasil pindai, coba gunakan alat OCR PDFree terlebih dahulu.',
  gls_intro:                  'Alat ini membuat highlight yang bisa diklik di atas istilah yang cocok — tidak mengubah atau menulis ulang teks asli PDF Anda.',
  gls_file_label:              'File',
  gls_dictionary_label:        'Kamus istilah',
  gls_dictionary_hint:         'Satu entri per baris: istilah - definisi',
  gls_dictionary_placeholder:  'dharma - hukum kosmis dan kewajiban\nkarma - prinsip sebab dan akibat',
  gls_parsed_count:            '{n} istilah terdeteksi',
  ...
  rsz_size_custom: 'Kustom',
  rsz_custom_width: 'Lebar (mm)',
  rsz_custom_height: 'Tinggi (mm)',
  ...
  fb_attach_screenshot:  '📎 Tangkapan layar',
  ...
  rdct_pii_iban:           '🏦 IBAN',
  rdct_pii_url:            '🌐 URL',
  rdct_pii_ai_name:        '🤖 Nama AI (Beta)',
  rdct_ai_name_disclosure: 'Nama & lokasi terdeteksi AI. Bekerja paling baik dengan teks bahasa Inggris — selalu tinjau sebelum menerapkan.',
  rdct_ai_name_loading:    'Memuat model AI…',
  rdct_ai_name_error:      'Gagal memuat model AI. Periksa koneksi Anda dan coba lagi.',
  ...
  wm_pos_bottom:         'Bawah',
  wm_pos_tile:           'Ubin',
  wm_rotation_label:    'Rotasi',
  wm_rotation_auto:     'Otomatis',
  wm_pagerange_label:   'Terapkan ke halaman',
  wm_from_page:         'Dari halaman',
  wm_to_page:           'Sampai halaman',
  wm_to_page_all:       '(∞ = semua)',
  wm_aria_dec_from:     'Kurangi halaman awal',
  wm_aria_inc_from:     'Tambah halaman awal',
  wm_aria_dec_to:       'Kurangi halaman akhir',
  wm_aria_inc_to:       'Tambah halaman akhir',
  wm_layer_label:       'Lapisan',
  wm_layer_front:       'Di depan',
  wm_layer_behind:      'Di belakang konten',
  wm_layer_behind_hint: 'Pratinjau selalu menampilkan watermark di depan — pada PDF yang diunduh, watermark akan tampil di belakang konten halaman.',
  ...
  val_formfields_dropdown_empty: "Tambahkan setidaknya satu pilihan ke setiap kolom dropdown",
  ...
  j2p_scan_brightness:       'Kecerahan',
  j2p_scan_contrast:         'Kontras',
  j2p_scan_reset:            'Atur Ulang',
  ...
  scan_cam_rotate_left:      'Putar ke kiri',
  scan_cam_rotate_right:     'Putar ke kanan',
  scan_cam_reset_crop:       'Atur ulang crop',
  scan_cam_erase:            'Hapus',
  scan_cam_erase_brush:      'Kuas',
  scan_cam_erase_done:       'Selesai',
  scan_cam_brush_small:      'Kuas kecil',
  scan_cam_brush_medium:     'Kuas sedang',
  scan_cam_brush_large:      'Kuas besar',
  ...
  sd_batch_title:          'Pemrosesan batch',
  sd_batch_prompt:         'Anda memilih {n} foto. Tinjau satu per satu, atau potong dan filter semuanya secara otomatis?',
  sd_batch_review_each:    'Tinjau satu per satu',
  sd_batch_auto_all:       'Terapkan ke semua secara otomatis',
  ...
  j2p_separate_pdfs:   'PDF terpisah',
  j2p_separate_desc:   'Satu PDF per gambar, diunduh sebagai ZIP — bukan satu file gabungan',
  ...
  p2w_strip_meta_title: 'Hapus info asli file',
  p2w_strip_meta_subtitle: 'Menghapus penulis, judul, dan info identitas lain dari PDF pada hasil',
  p2w_keep_meta_hint: '🔓 Penulis dan judul asli PDF Anda akan tetap disimpan pada hasil, menggantikan info file umum PDFree.',
  ...
  p2p_output_mode:          'Keluaran',
  p2p_conversion_mode_aria: 'Mode konversi PowerPoint',
  p2p_mode_image:           '🖼️ Gambar',
  p2p_mode_text:            '📝 Teks yang dapat diedit (beta)',
  ...
  merge_next_extract_title: 'Lanjutkan ke Ekstrak Halaman',
  merge_next_extract_sub:   'Pilih persis halaman yang Anda butuhkan dari file gabungan ini — terbuka seketika, tanpa perlu unggah ulang.',
  cleanscan_next_ocr_title: 'Lanjutkan ke OCR PDF',
  cleanscan_next_ocr_sub:   'Jadikan teks yang telah dibersihkan bisa dipilih dan dicari — pindaian yang lebih putih dan tajam dikenali lebih akurat.',
  ...
  fill_forget_saved:         'Lupakan tanda tangan tersimpan',
  ...
  formfields_type_radio: "Tombol radio",
  formfields_type_dropdown: "Dropdown",
  formfields_group_label: "Nama grup tombol radio",
  formfields_group_placeholder: "Nama grup",
  formfields_new_group: "Grup baru",
  formfields_group_hint: "Tombol radio yang ditempatkan dengan nama ini menjadi satu grup — hanya satu yang bisa dipilih. Mengubah namanya akan mengganti nama seluruh grup; gunakan Grup baru untuk memulai grup lain.",
  formfields_options_label: "Pilihan dropdown (dipisahkan koma)",
  formfields_options_placeholder: "Kecil, Sedang, Besar",
  formfields_options_hint: "Ketik setiap pilihan dipisahkan koma. Klik dropdown yang sudah ditempatkan untuk mengubah pilihannya.",
  formfields_radio_box_title: "Grup: {group} · Opsi: {value}",
  ...
  formfields_default_option_name: "Opsi {n}",
  formfields_default_group_name: "Grup {n}",
  formfields_default_options: "Opsi 1, Opsi 2, Opsi 3",
  ...
  read_font_size:             'Ukuran teks',
  read_no_text_title:         'Tidak ditemukan teks yang dapat dibaca',
  ...
  read_try_ocr:               'Coba OCR',
  read_error:                 'Tidak dapat membaca PDF ini.',
  read_password_title:        'Dilindungi kata sandi',
  read_password_retry:        'Incorrect password -- try again.',
  read_password_placeholder:  'Enter password...',
  read_password_open:         'Buka',
  read_cancel:                'Batal',
  read_reading_mode:          'Mode baca',
  read_exit_reading_mode:     'Keluar dari mode baca',
  read_exit_hint_esc:         'Tekan Esc untuk keluar dari mode baca',
  read_exit_hint_tap:         'Ketuk tombol tutup untuk keluar dari mode baca',
};
