...
window.PDFREE_LOCALE = {
  ...
  prog_glossary_load:   'Đang tải PDF...',
  prog_glossary_search: 'Đang tìm thuật ngữ...',
  prog_glossary_write:  'Đang thêm định nghĩa...',
  ...
  desc_glossary:            'Đã thêm {count} định nghĩa',
  ...
  warn_glossary_truncated: '⚠️ Quá nhiều kết quả khớp — chỉ {n} kết quả đầu tiên được chú thích. Hãy thử thu hẹp danh sách thuật ngữ của bạn.',
  ...
  val_glossary_no_dictionary: 'Thêm một PDF và ít nhất một thuật ngữ để tiếp tục.',
  val_glossary_no_matches:    'Không tìm thấy thuật ngữ nào trong từ điển của bạn trong PDF này.',
  val_glossary_no_text_layer: 'PDF này không có văn bản có thể chọn — Từ điển cần một PDF dựa trên văn bản. Nếu đây là tài liệu được quét, hãy thử công cụ OCR của PDFree trước.',
  gls_intro:                  'Công cụ này tạo các điểm nhấn có thể nhấp vào trên các thuật ngữ khớp — không thay đổi hay viết lại văn bản gốc trong PDF của bạn.',
  gls_file_label:              'Tệp',
  gls_dictionary_label:        'Từ điển thuật ngữ',
  gls_dictionary_hint:         'Mỗi dòng một mục: thuật ngữ - định nghĩa',
  gls_dictionary_placeholder:  'dharma - quy luật vũ trụ và bổn phận\nkarma - nguyên lý nhân quả',
  gls_parsed_count:            'Đã nhận diện {n} thuật ngữ',
  ...
  rsz_size_custom: 'Tùy chỉnh',
  rsz_custom_width: 'Chiều rộng (mm)',
  rsz_custom_height: 'Chiều cao (mm)',
  ...
  hero_multi_docx_label:  '{n} tệp Word',
  ...
  fb_attach_screenshot:  '📎 Ảnh chụp màn hình',
  ...
  rdct_pii_iban:           '🏦 IBAN',
  rdct_pii_url:            '🌐 URL',
  rdct_pii_ai_name:        '🤖 Tên AI (Beta)',
  rdct_ai_name_disclosure: 'Tên & địa điểm do AI phát hiện. Hoạt động tốt nhất với văn bản tiếng Anh — luôn kiểm tra trước khi áp dụng.',
  rdct_ai_name_loading:    'Đang tải mô hình AI…',
  rdct_ai_name_error:      'Không thể tải mô hình AI. Kiểm tra kết nối và thử lại.',
  ...
  wm_pos_bottom:         'Dưới',
  wm_pos_tile:           'Lưới',
  wm_rotation_label:    'Xoay',
  wm_rotation_auto:     'Tự động',
  wm_pagerange_label:   'Áp dụng cho trang',
  wm_from_page:         'Từ trang',
  wm_to_page:           'Đến trang',
  wm_to_page_all:       '(∞ = tất cả)',
  wm_aria_dec_from:     'Giảm trang bắt đầu',
  wm_aria_inc_from:     'Tăng trang bắt đầu',
  wm_aria_dec_to:       'Giảm trang kết thúc',
  wm_aria_inc_to:       'Tăng trang kết thúc',
  wm_layer_label:       'Lớp',
  wm_layer_front:       'Ở trước',
  wm_layer_behind:      'Phía sau nội dung',
  wm_layer_behind_hint: 'Bản xem trước luôn hiển thị hình mờ ở trên cùng — trong tệp PDF đã tải xuống, nó sẽ hiển thị phía sau nội dung trang.',
  ...
  val_formfields_dropdown_empty: "Thêm ít nhất một lựa chọn cho mỗi danh sách thả xuống",
  ...
  scan_cam_rotate_left:      'Xoay trái',
  scan_cam_rotate_right:     'Xoay phải',
  scan_cam_reset_crop:       'Đặt lại vùng cắt',
  scan_cam_erase:            'Xóa',
  scan_cam_erase_brush:      'Cọ vẽ',
  scan_cam_erase_done:       'Xong',
  scan_cam_brush_small:      'Cọ nhỏ',
  scan_cam_brush_medium:     'Cọ vừa',
  scan_cam_brush_large:      'Cọ lớn',
  ...
  sd_batch_title:          'Xử lý hàng loạt',
  sd_batch_prompt:         'Bạn đã chọn {n} ảnh. Xem lại từng ảnh, hay tự động cắt và lọc tất cả?',
  sd_batch_review_each:    'Xem lại từng ảnh',
  sd_batch_auto_all:       'Áp dụng tự động cho tất cả',
  ...
  j2p_separate_pdfs:   'PDF riêng biệt',
  j2p_separate_desc:   'Mỗi ảnh một PDF, tải xuống dưới dạng ZIP — thay vì một tệp gộp chung',
  ...
  p2w_strip_meta_title: 'Xóa thông tin gốc của tệp',
  p2w_strip_meta_subtitle: 'Xóa tác giả, tiêu đề và các thông tin nhận dạng khác của PDF khỏi kết quả',
  p2w_keep_meta_hint: '🔓 Tác giả và tiêu đề gốc của PDF sẽ được giữ lại trong kết quả, thay vì thông tin tệp chung của PDFree.',
  ...
  atlas_check_scope_note_md: 'Mức độ tin cậy khi nắm bắt bảng và luồng đoạn văn — không phải đánh giá toàn bộ tài liệu.',
  ...
  p2p_output_mode:          'Đầu ra',
  p2p_conversion_mode_aria: 'Chế độ chuyển đổi PowerPoint',
  p2p_mode_image:           '🖼️ Hình ảnh',
  p2p_mode_text:            '📝 Văn bản có thể chỉnh sửa (beta)',
  ...
  merge_next_extract_title: 'Tiếp tục với Trích Xuất Trang',
  merge_next_extract_sub:   'Chọn chính xác các trang bạn cần từ tệp đã gộp này — mở ngay lập tức, không cần tải lên lại.',
  cleanscan_next_ocr_title: 'Tiếp tục với OCR PDF',
  cleanscan_next_ocr_sub:   'Biến văn bản đã làm sạch thành có thể chọn và tìm kiếm được — bản quét trắng hơn, sắc nét hơn sẽ được nhận dạng chính xác hơn.',
  ...
  fill_forget_saved:         'Quên chữ ký đã lưu',
  fill_tab_draw:              'Vẽ',
  fill_tab_type:              'Nhập',
  ...
  formfields_type_radio: "Nút chọn",
  formfields_type_dropdown: "Danh sách thả xuống",
  formfields_group_label: "Tên nhóm nút chọn",
  formfields_group_placeholder: "Tên nhóm",
  formfields_new_group: "Nhóm mới",
  formfields_group_hint: "Các nút chọn được đặt với tên này tạo thành một nhóm — chỉ chọn được một nút. Sửa tên sẽ đổi tên cả nhóm; dùng Nhóm mới để bắt đầu nhóm khác.",
  formfields_options_label: "Lựa chọn trong danh sách (phân tách bằng dấu phẩy)",
  formfields_options_placeholder: "Nhỏ, Vừa, Lớn",
  formfields_options_hint: "Nhập từng lựa chọn, phân tách bằng dấu phẩy. Nhấp vào một danh sách đã đặt để sửa các lựa chọn của nó.",
  formfields_radio_box_title: "Nhóm: {group} · Lựa chọn: {value}",
  ...
  formfields_default_dropdown_name: "Danh sách {n}",
  formfields_default_option_name: "Lựa chọn {n}",
  formfields_default_group_name: "Nhóm {n}",
  formfields_default_options: "Lựa chọn 1, Lựa chọn 2, Lựa chọn 3",
  ...
  read_font_size:             'Cỡ chữ',
  read_no_text_title:         'Không tìm thấy văn bản có thể đọc được',
  ...
  read_try_ocr:               'Thử OCR',
  read_error:                 'Không thể đọc tệp PDF này.',
  read_password_title:        'Được bảo vệ bằng mật khẩu',
  read_password_retry:        'Incorrect password -- try again.',
  read_password_placeholder:  'Enter password...',
  read_password_open:         'Mở',
  read_cancel:                'Hủy',
  read_reading_mode:          'Chế độ đọc',
  read_exit_reading_mode:     'Thoát chế độ đọc',
  read_exit_hint_esc:         'Nhấn Esc để thoát chế độ đọc',
  read_exit_hint_tap:         'Nhấn nút đóng để thoát chế độ đọc',
};
