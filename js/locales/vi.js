...
window.PDFREE_LOCALE = {
  ...
  pdfa_convert_btn:            '📐 Chuyển sang PDF/A-2b',
  ...
  pdfa_convert_success:        '✓ Đã chuyển đổi — quá trình tự kiểm tra đã xác nhận các dấu hiệu OutputIntent và XMP trong tệp đã tải xuống.',
