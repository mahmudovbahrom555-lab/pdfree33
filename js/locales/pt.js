...
window.PDFREE_LOCALE = {
  ...
  rdct_banner_cover:       '🛡️ <strong>Cobrir área</strong> — desenha um retângulo opaco sobre a região selecionada. O conteúdo abaixo está oculto visualmente mas <em>não deletado criptograficamente</em>. Para redação legal use a ferramenta <a href="/redact-pdf/" style="color:var(--green)">Redigir PDF</a>.',
