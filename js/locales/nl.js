...
window.PDFREE_LOCALE = {
  ...
  pdfa_compliant:              '✓ Deze PDF voldoet aan de structurele vereisten voor PDF/A-2b.',
  pdfa_not_compliant:          'Deze PDF voldoet nog niet aan PDF/A-2b — zie de problemen hierboven.',
  pdfa_convert_btn:            '📐 Converteren naar PDF/A-2b',
  pdfa_converting:             'Converteren…',
  pdfa_convert_failed:         'Conversie mislukt',
  pdfa_convert_failed_detail:  'Conversie mislukt: {message}',
  pdfa_convert_success:        '✓ Geconverteerd — de zelfcontrole heeft de OutputIntent- en XMP-markeringen in het gedownloade bestand bevestigd.',
