...
window.PDFREE_LOCALE = {
  ...
  wm_color_blue:         'Mavi',
  wm_opacity_label:      'Saydamlık',
  wm_opacity_hint:       'Daha düşük saydamlık, logonun dolu kısımlarının altındaki belge metnini okunabilir tutar.',
  wm_size_label:         'Boyut',
  wm_preview_label:      'Önizleme',
  wm_preview_aria:       'Filigran önizlemesi',
  wm_preview_img_aria:   'Filigran yerleşim önizlemesi',
  wm_aria_opacity:       'Saydamlık {pct}%',
