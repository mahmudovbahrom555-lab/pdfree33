...
window.PDFREE_LOCALE = {
  ...
  search_tags: {
    ...
    mangaSplit:       ['manga böl', 'çift sayfa manga', 'manga ayır', 'sağdan sola', 'manhwa böl', 'manga pdf böl'],
    cleanScan:           ['taramayı temizle', 'arka planı beyazlat', 'gri arka planı kaldır', 'taranan sayfayı aydınlat', 'taramadan gölgeyi kaldır', 'tarama temizleme'],
    ereader:             ['ereader', 'e-okuyucu', 'kindle', 'kobo', 'kenar boşluklarını kırp', 'kindle için optimize et', 'e-ink', 'kenar boşluklarını küçült', 'pdf gri tonlama'],
    ...
    read:             ['oku', 'okuma modu', 'telefonda oku', 'pdf telefonda okuma', 'okuma görünümü', 'metni yeniden düzenle'],
  },
  ...
  download_toast:     '📥 {filename} indirildi',
  ...
  prog_glossary_load:   'PDF yükleniyor...',
  prog_glossary_search: 'Terimler aranıyor...',
  prog_glossary_write:  'Tanımlar ekleniyor...',
  prog_resize:       'Sayfa boyutu değiştiriliyor...',
  prog_clean_scan_load:       'PDF yükleniyor...',
  prog_clean_scan_page:       'Sayfa {n}/{total} temizleniyor...',
  prog_fill_order:       'Sekme sırası yeniden düzenleniyor...',
  prog_flatten:      'Form alanları kilitleniyor...',
  prog_manga_split:  'Sayfalar bölünüyor...',
  ...
  desc_glossary:            '{count} tanım eklendi',
  ...
  err_out_of_memory:   "Bu dosya işlenirken cihazınızın belleği yetersiz kaldı — bu gerçek bir donanım sınırıdır, hata değildir. Daha küçük bir sayfa aralığı deneyin, diğer tarayıcı sekmelerini kapatın veya (birden fazla dosya çıktısı için) ayrı dosyalar yerine tek bir birleştirilmiş dosyaya geçin. PDFree'yi kullandığınız için teşekkürler — bu seferki sorunsuz gitmediği için üzgünüz.",
  ...
  warn_glossary_truncated: '⚠️ Çok fazla eşleşme var — yalnızca ilk {n} tanesine tanım eklendi. Terim listenizi daraltmayı deneyin.',
  ...
  val_glossary_no_dictionary: 'Devam etmek için bir PDF ve en az bir terim ekleyin.',
  val_glossary_no_matches:    "Sözlüğünüzdeki terimlerden hiçbiri bu PDF'de bulunamadı.",
  val_glossary_no_text_layer: "Bu PDF'de seçilebilir metin yok — Sözlük, metin tabanlı bir PDF gerektirir. Taranmış bir belgeyse önce PDFree'nin OCR aracını deneyin.",
  gls_intro:                  "Bu araç, eşleşen terimlerin üzerine tıklanabilir vurgular oluşturur — PDF'inizin orijinal metnini değiştirmez veya yeniden yazmaz.",
  gls_file_label:              'Dosya',
  gls_dictionary_label:        'Terim sözlüğü',
  gls_dictionary_hint:         'Satır başına bir giriş: terim - tanım',
  gls_dictionary_placeholder:  'dharma - kozmik yasa ve görev\nkarma - neden ve sonuç ilkesi',
  gls_parsed_count:            '{n} terim algılandı',
  ...
  rsz_size_custom: 'Özel',
  rsz_custom_width: 'Genişlik (mm)',
  rsz_custom_height: 'Yükseklik (mm)',
  ...
  ms_loading: 'PDF yükleniyor…',
  ms_err_load: 'PDF okunamadı: {msg}',
  ms_rtl_title: 'Manga okuma sırası',
  ms_rtl_subtitle: 'Sonuçta sağ sayfa önce gelir',
  ms_grid_aria: 'PDF sayfaları — bölünmemesi için bir sayfaya tıklayın',
  ms_page_aria: 'Sayfa {n}',
  ms_page_alt: 'Sayfa {n}',
  ms_skipped_suffix: ' (bölünmedi)',
  ms_skip_title: 'Bu sayfayı bölme',
  ms_restore_title: 'Bu sayfayı böl',
  ms_hint: 'Bölünmemesi için bir sayfaya tıklayın — kapaklar veya tekli sayfalar için kullanışlıdır',
  ms_banner: '🔒 Tamamen tarayıcınızda işlenir · Yükleme yok',
  ms_survey_title: 'Kısa bir soru (isteğe bağlı)',
  ms_survey_why: 'Bu sayfaları neden böldünüz?',
  ms_survey_why_print: 'Yazdırmak için',
  ms_survey_why_device: 'Bir cihazda okumak için',
  ms_survey_why_other: 'Diğer',
  ms_survey_annoying: 'Süreçte en can sıkıcı kısım neydi?',
  ms_survey_before: 'Bu araçtan önce ne kullanıyordunuz?',
  ms_survey_pay_q: 'Gelişmiş bir sürüm için (metin, kitapçık düzeni) ödeme yapar mıydınız?',
  ms_survey_pay_yes: 'Evet',
  ms_survey_pay_no: 'Hayır',
  ms_survey_pay_maybe: 'Belki',
  ms_survey_submit: 'Gönder',
  ms_survey_skip: 'Atla',
  ms_survey_thanks: 'Geri bildiriminiz için teşekkürler!',
  cs_loading: 'Tarama analiz ediliyor…',
  cs_err_load: 'PDF okunamadı: {msg}',
  cs_mode: 'Mod',
  cs_mode_clean: 'Temizle',
  cs_mode_enhance: 'İyileştir',
  cs_strength: 'Güç',
  cs_quality: 'Kalite',
  cs_quality_standard: 'Standart',
  cs_quality_high: 'Yüksek kalite',
  cs_preview_page: 'Önizleme sayfası',
  cs_before: 'Önce',
  cs_after: 'Sonra',
  cs_color_warning: 'Bu sayfa renk içeriyor — Temizle modu onu kaldırabilir.',
  cs_switch_enhance: "İyileştir'e geç",
  cs_digital_warning: 'Bu bir tarama gibi görünmüyor — temizleme metni görsele dönüştürebilir.',
  cs_banner: '🔒 Tamamen tarayıcınızda işlenir · Yükleme yok',
  prog_ereader_load: 'PDF yükleniyor...',
  prog_ereader_analyze: 'Kenar boşlukları algılanıyor...',
  prog_ereader_page: 'Sayfa {n}/{total} optimize ediliyor...',
  desc_ereader: 'E-okuyucu için optimize edildi · {pages} sayfa · {size}',
  er_loading: 'Sayfalar analiz ediliyor…',
  er_err_load: 'PDF okunamadı: {msg}',
  er_device: 'Cihaz',
  er_device_kindle: 'Kindle',
  er_device_remarkable: 'reMarkable / Boox',
  er_device_kobo: 'Kobo / Nook',
  er_grayscale: 'Gri tonlama',
  er_contrast: 'Kontrast',
  er_preview_page: 'Önizleme sayfası',
  er_before: 'Önce',
  er_after: 'Sonra',
  ...
  hero_multi_docx_label:  '{n} Word dosyası',
  ...
  fb_attach_screenshot:  '📎 Ekran görüntüsü',
  ...
  rdct_pii_iban:           '🏦 IBAN',
  rdct_pii_url:            '🌐 URL',
  rdct_pii_ai_name:        '🤖 YZ İsimleri (Beta)',
  rdct_ai_name_disclosure: 'YZ ile tespit edilen isimler ve yerler. En iyi İngilizce metinle çalışır — uygulamadan önce her zaman kontrol edin.',
  rdct_ai_name_loading:    'YZ modeli yükleniyor…',
  rdct_ai_name_error:      'YZ modeli yüklenemedi. Bağlantınızı kontrol edip tekrar deneyin.',
  ...
  wm_pos_bottom:         'Alt',
  wm_pos_tile:           'Döşeme',
  wm_rotation_label:    'Döndürme',
  wm_rotation_auto:     'Otomatik',
  wm_pagerange_label:   'Sayfalara uygula',
  wm_from_page:         'Başlangıç sayfası',
  wm_to_page:           'Bitiş sayfası',
  wm_to_page_all:       '(∞ = tümü)',
  wm_aria_dec_from:     'Başlangıç sayfasını azalt',
  wm_aria_inc_from:     'Başlangıç sayfasını artır',
  wm_aria_dec_to:       'Bitiş sayfasını azalt',
  wm_aria_inc_to:       'Bitiş sayfasını artır',
  wm_layer_label:       'Katman',
  wm_layer_front:       'Önde',
  wm_layer_behind:      'İçeriğin arkasında',
  wm_layer_behind_hint: 'Önizleme filigranı her zaman önde gösterir — indirilen PDF\'de filigran sayfa içeriğinin arkasında görüntülenir.',
  wm_color_label:        'Renk',
  wm_color_gray:         'Gri',
  ...
  val_formfields_dropdown_empty: "Her açılır liste alanına en az bir seçenek ekleyin",
  ...
  scan_cam_rotate_left:      'Sola döndür',
  scan_cam_rotate_right:     'Sağa döndür',
  scan_cam_reset_crop:       'Kırpmayı sıfırla',
  scan_cam_erase:            'Sil',
  scan_cam_erase_brush:      'Fırça',
  scan_cam_erase_done:       'Bitti',
  scan_cam_brush_small:      'Küçük fırça',
  scan_cam_brush_medium:     'Orta fırça',
  scan_cam_brush_large:      'Büyük fırça',
  ...
  sd_batch_title:          'Toplu işlem',
  sd_batch_prompt:         '{n} fotoğraf seçtiniz. Her birini incelemek mi, yoksa hepsini otomatik olarak kırpıp filtrelemek mi istersiniz?',
  sd_batch_review_each:    'Her birini incele',
  sd_batch_auto_all:       'Tümüne otomatik uygula',
  ...
  j2p_separate_pdfs:   'Ayrı PDF\'ler',
  j2p_separate_desc:   'Her görüntü için ayrı bir PDF, ZIP olarak indirilir — birleştirilmiş tek dosya yerine',
  j2p_quality:         'Kalite',
  ...
  p2w_strip_meta_title: 'Özgün dosya bilgilerini sil',
  p2w_strip_meta_subtitle: 'PDF\'in yazarını, başlığını ve diğer tanımlayıcı bilgilerini sonuçtan kaldırır',
  p2w_keep_meta_hint: '🔓 PDF\'inizin özgün yazar ve başlık bilgisi, genel PDFree dosya bilgisi yerine sonuçta korunacak.',
  ...
  atlas_check_scope_note_md: 'Tabloların ve paragraf akışının ne kadar güvenilir şekilde yakalandığı — tam bir belge incelemesi değildir.',
  ...
  p2p_output_mode:          'Çıktı',
  p2p_conversion_mode_aria: 'PowerPoint dönüştürme modu',
  p2p_mode_image:           '🖼️ Görüntü',
  p2p_mode_text:            '📝 Düzenlenebilir metin (beta)',
  ...
  merge_next_extract_title: 'Sayfa Çıkarma\'ya devam et',
  merge_next_extract_sub:   'Bu birleştirilmiş dosyadan tam olarak ihtiyacınız olan sayfaları seçin — anında açılır, yeniden yükleme gerekmez.',
  cleanscan_next_ocr_title: 'OCR PDF\'e devam et',
  cleanscan_next_ocr_sub:   'Temizlenmiş metni seçilebilir ve aranabilir hale getirin — daha beyaz, daha keskin bir tarama daha doğru tanınır.',
  ...
  fill_forget_saved:         'Kayıtlı imzayı unut',
  fill_tab_draw:              'Çiz',
  fill_tab_type:              'Yaz',
  ...
  formfields_type_radio: "Seçenek düğmesi",
  formfields_type_dropdown: "Açılır liste",
  formfields_group_label: "Seçenek grubu adı",
  formfields_group_placeholder: "Grup adı",
  formfields_new_group: "Yeni grup",
  formfields_group_hint: "Bu adla yerleştirilen seçenek düğmeleri tek bir grup oluşturur — yalnızca biri seçilebilir. Adı düzenlemek tüm grubu yeniden adlandırır; başka bir grup başlatmak için Yeni grup düğmesini kullanın.",
  formfields_options_label: "Açılır liste seçenekleri (virgülle ayrılmış)",
  formfields_options_placeholder: "Küçük, Orta, Büyük",
  formfields_options_hint: "Her seçeneği virgülle ayırarak yazın. Seçeneklerini düzenlemek için yerleştirilmiş bir açılır listeye tıklayın.",
  formfields_radio_box_title: "Grup: {group} · Seçenek: {value}",
  ...
  formfields_default_dropdown_name: "Açılır liste {n}",
  formfields_default_option_name: "Seçenek {n}",
  formfields_default_group_name: "Grup {n}",
  formfields_default_options: "Seçenek 1, Seçenek 2, Seçenek 3",
  ...
  read_font_size:             'Metin boyutu',
  read_no_text_title:         'Okunabilir metin bulunamadı',
  ...
  read_try_ocr:               'OCR\'yi dene',
  read_error:                 'Bu PDF okunamadı.',
  read_password_title:        'Parola ile korunuyor',
  read_password_retry:        'Incorrect password -- try again.',
  read_password_placeholder:  'Enter password...',
  read_password_open:         'Aç',
  read_cancel:                'İptal',
  read_reading_mode:          'Okuma modu',
  read_exit_reading_mode:     'Okuma modundan çık',
  read_exit_hint_esc:         'Okuma modundan çıkmak için Esc\'ye basın',
  read_exit_hint_tap:         'Okuma modundan çıkmak için kapat düğmesine dokunun',
};
